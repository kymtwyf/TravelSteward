...
model.status = {
	...
	*/
	...
	popPath:function(){//一次pop 两个
		console.log('before pop the status is ');
		console.log(model.status);
		console.log('before pop the data is ');
		...
		console.log('after pop the status is ');
		console.log(model.status);
		console.log('after pop the data is ');
		console.log(model.data);
		...
		console.log('after switch the status is ');

		console.log(model.status);

		console.log('after switch the data is ');
